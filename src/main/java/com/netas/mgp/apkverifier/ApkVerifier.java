...
import com.netas.mgp.apkverifier.internal.apk.v2.ContentDigestAlgorithm;
import com.netas.mgp.apkverifier.internal.apk.v2.SignatureAlgorithm;
import com.netas.mgp.apkverifier.internal.apk.v2.V2SchemeVerifier;
import com.netas.mgp.apkverifier.util.DataSource;
import com.netas.mgp.apkverifier.zip.ZipFormatException;
...
public class ApkVerifier {
	 ...
	 * considered verified iff the result's {@link Result#isVerified()} returns {@code true}. The
	 * verification result also includes errors, warnings, and information about signers.
	 *
	 * @param apk
	 *            APK file contents
	 * @param minSdkVersion
	 *            API Level of the oldest Android platform on which the APK's signatures may need to
	 *            be verified
	 *
	 * @throws IOException
	 *             if an I/O error is encountered while reading the APK
	 * @throws ZipFormatException
	 *             if the APK is malformed at ZIP format level
	 */
