...
package com.netas.mgp.apkverifier.apk;
...
public class ApkUtils {
	 ...
	 *
	 * @throws IOException
	 *             if an I/O error occurred while reading the APK
	...
	public static class ZipSections {
		...
		/**
		 * Returns the start offset of the ZIP Central Directory. This value is taken from the ZIP
	 ...
	 * Directory record.
	 *
	 * @param zipEndOfCentralDirectory
	 *            APK's ZIP End of Central Directory record
	 * @param offset
	 *            offset of the ZIP Central Directory relative to the start of the archive. Must be
	 *            between {@code 0} and {@code 2^32 - 1} inclusive.
	 */
